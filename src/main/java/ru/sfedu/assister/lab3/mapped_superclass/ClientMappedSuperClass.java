...
@Entity
@Table(name = "ClientMappedSuperClass")
public class ClientMappedSuperClass extends UserMappedSuperClass{
    ...
    public ClientMappedSuperClass(long userId, String name, String surname, Integer age, Integer weight, Integer height, Byte awaiting) {
    ...
    public boolean equals(Object o) {
        ...
        ClientMappedSuperClass that = (ClientMappedSuperClass) o;
