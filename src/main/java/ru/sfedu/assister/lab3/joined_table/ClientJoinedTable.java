package ru.sfedu.assister.lab3.joined_table;

import javax.persistence.*;

@Entity
@Table(name = "ClientJoinedTable")
public class ClientJoinedTable extends UserJoinedTable{
    ...
    public ClientJoinedTable(long userId, String name, String surname, Integer age, Integer weight, Integer height, Byte awaiting) {
    ...
    public boolean equals(Object o) {
        ...
        ClientJoinedTable that = (ClientJoinedTable) o;
