package ru.silonov.accountantspring.model;
...
public class Report {
    ...
    public Report(int id, String date, int time, String task, int userId) {
        this.id = id;
        this.date = date;
        this.time = time;
        this.task = task;
    ...
    public Report(String task, int time, int userId) {
        this.time = time;
        this.task = task;
        this.userId = userId;
    }

    public Report(int time, String task, int userId) {
        this.time = time;
        this.task = task;
        this.userId = userId;
    }
